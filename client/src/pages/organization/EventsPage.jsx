...
const EventsPage = () => {
  ...
  const fetchEvents = async () => {
    try {
      setIsLoading(true);
      const response = await organizationAPI.getEvents();
  ...
  const handleDeleteEvent = async () => {
    try {
      await organizationAPI.deleteEvent(selectedEvent._id);
      ...
      {filteredEvents.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-4">
            {searchTerm || statusFilter || categoryFilter ? 'Try adjusting your search or filters' : 'You haven\'t created any events yet'}
          </p>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                  <div className="flex items-center space-x-2">
                    ...
                    <Link
                      to={`/organization/events/${event._id}/edit`}
          ...
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            ...
                            <p className="text-sm text-gray-900">
                              {selectedEvent.participants?.length || 0} / {selectedEvent.maxParticipants || 'Unlimited'}
                            </p>
                          </div>
                          <div>
              ...
              <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <Link
                  to={`/organization/events/${selectedEvent._id}/edit`}
